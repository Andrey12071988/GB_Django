...
from myapp.models import Item, Order, Client
from myapp.forms import ItemForm


def get_index(request):
    return render(request, 'myapp/index.html', context={'title': 'Главная'})
...
def add_item(request):
    if request.method == 'POST':
        ...
        form = ItemForm()
    return render(request, 'myapp/add_item.html', context={'title': 'Добавить новый товар',
                                                                   'form': form})
...
def update_item(request, pk):
    ...
    return render(request, 'myapp/add_item.html', context={'title': 'Обновить товар',
                                                                   'form': form})
